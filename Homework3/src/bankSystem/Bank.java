...
public class Bank {
	...
	public static void main(String[] args) {
		...
		Customer[] personal = new Personal[5];
		personal[0] = new Personal("Stacey A. Gage", "3801 College Street, Atlanta, GA 30318", "(404) 408-8541", "(404) 408-8451", "(404) 408-1845");
		personal[1] = new Personal("Joseph M. Anderson", "2069 West Drive, Kokomo, IN 46903", "(765) 475-0095", "(765) 475-9632", "(765) 476-1184");
		personal[2] = new Personal("Blanca P. Joiner", "3083 Spring Street, Kokomo, IN 46901", "(765) 598-3550", "(765) 598-3505", "(765) 598-5503");
		
		Customer[] commercial = new Commercial[5];
		commercial[0] = new Commercial("Joiner & Joiner, LLP", "3083 Spring Street, Springfield, IL 62701", "(217) 782-6327", "AAA", "Timothy D. Ball", "(205) 324-7812");
		commercial[1] = new Commercial("", "3808 Rhapsody Street, Kokomo, IN 46902", "(765) 315-2588", "AA", "(765) 315-8258", "(765) 315-8582");
		...
		account.add(new Checking("CK23564", 5.00, "Rocky Mountains", 5.00, indianaStateBank[0], commercial[0] ));
		...
		account.add(new  Savings("SV23564", 100.0, 10.0, indianaStateBank[0], personal[0] ));
		...
		// (g)
			...
			account.add(new Savings("SVK7896", 0.00, 3.0, indianaStateBank[1], personal[1]));
			...
			account.add(new Checking("CK23564", 0.00, "Nascar", 25.00, indianaStateBank[1], personal[2]));
			...
			*/
			...
			account.add(new Savings("SVK48321", 105.35, 8.25, indianaStateBank[1], commercial[1]));

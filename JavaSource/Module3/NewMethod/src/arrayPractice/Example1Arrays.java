...
public class Example1Arrays
{
	public static void main (String args[])
	{
        ...
        for (double element: trialArray)
        	System.out.println("This is the for each loop: " + element);
...
/*
 ...
 In Java: Primitive data types are always passed by value. You can't pass them by reference.

...
Using the Math class
	...
	Note:
	A static import declaration (a new feature of J2SE 5.0) enables programmers to refer
	to imported static members as if they were declared in the class that uses them-the class
	name and a dot (.) are not required to use an imported static member.
	you can say: import static java.lang.Math.*;

	then you can always say: sqrt(9) ..... no need for Math.sqrt(9)
